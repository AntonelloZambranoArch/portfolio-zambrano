    ...
    <section id="contatti" className="py-24 bg-[#090d16] border-t border-gray-800/40 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="eyebrow text-sm font-semibold tracking-wider text-primary uppercase mb-2">Contatti</h2>
          <h3 className="font-display text-3xl sm:text-4xl font-semibold text-white">Avvia una Collaborazione</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 space-y-8">
            <h4 className="font-display text-xl font-semibold text-white mb-6 border-b border-gray-800 pb-3">Recapiti Diretti</h4>

            <div className="space-y-6">
              {/* Phone */}
              <div className="flex gap-4 p-5 rounded-xl bg-gray-900/10 border border-gray-800/60">
          ...
          <div className="lg:col-span-7 bg-gray-900/20 border border-gray-800/40 p-8 sm:p-10 rounded-2xl backdrop-blur-sm shadow-xl">
            <h4 className="font-display text-xl font-semibold text-white mb-6 border-b border-gray-800 pb-3">Invia un Messaggio</h4>
            ...
            {status.submitted ? (
              <div className="flex flex-col items-center justify-center py-12 text-center space-y-4">
                ...
                <button
                  ...
                  className="mt-6 inline-flex items-center px-4 py-2 border border-gray-700 text-sm font-medium rounded-lg text-gray-300 hover:text-white hover:bg-gray-800/60 hover:border-gray-600 transition-colors"
                >
